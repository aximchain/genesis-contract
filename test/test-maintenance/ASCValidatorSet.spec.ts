...
describe('ASCValidatorSet', () => {
  ...
  before('before', async () => {
    ...
    for (let i = 0; i < contractPaths.length; i++) {
      ...
      if (pathObj.name === 'ASCValidatorSet' || pathObj.name === 'GovHub') {
    ...
    validatorSet = instances[10] as ASCValidatorSet;
  ...
  it('query code size', async () => {
    ...
    log(`ASCValidatorSet Mock Template code size: ${codeSize}, UpperLimit: 24567` )
  });
